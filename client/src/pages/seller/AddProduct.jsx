...
import { assets } from '../../assets/assets'; // Ensure this is correct
...
const AddProduct = () => {
  ...
  // ✅ Dummy category list (you can replace with real ones)
  const categories = [
    { path: 'fruits' },
    { path: 'vegetables' },
    { path: 'dairy' },
...
//   // Dummy categories (replace with real categories if needed)
//   const categories = [
//     { path: 'fruits' },
//     { path: 'vegetables' },
//     { path: 'dairy' },
